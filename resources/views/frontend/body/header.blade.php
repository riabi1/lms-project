                    ...
                    <div class="header-widget">
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14">
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray">
                                ...
                                <a href="tel:00123456789">{{ optional($setting)->phone ?? 'N/A' }}</a>
                            </li>
                            <li class="d-flex align-items-center">
                                <i class="la la-envelope-o mr-1"></i>
                                <a href="mailto:{{ optional($setting)->email }}">{{ optional($setting)->email ?? 'N/A' }}</a>
                            </li>
                        </ul>
                    ...
                    <div class="col-lg-2">
                        <div class="logo-box">
                            <a href="{{ url('/') }}" class="logo">
                                <img src="{{ asset(optional($setting)->logo ?? 'images/default-logo.png') }}" alt="logo">
                            </a>
                        ...
                        <div class="menu-wrapper">
                            ...
                            <nav class="main-menu">
                                <ul>
                                    ...
                                    <li>
            <a href="{{ route('student.quiz') }}">Quiz</a> <!-- Lien Quiz pour les étudiants -->
        </li>
                                </ul><!-- end ul -->
                            </nav><!-- end main-menu -->
